 ...
 */
public class SearchMenuLayout extends LinearLayout implements IMasterTitle {

	private DefaultKeyFocus mKeyFocus;
	private View lasFocusedView;
	private IDetailContent gridView;

	public SearchMenuLayout(Context context) {
		super(context);
		initViews(context);
	}
	...
	public SearchMenuLayout(Context context, AttributeSet attrs, int defStyle) {
