 ...
 * 
 */
public class CommonScaleRectangleFocusView extends LinearLayout implements OnFocusChangeListener{
	...
	public CommonScaleRectangleFocusView(Context context) {
		super(context);
	}
	...
	public CommonScaleRectangleFocusView(Context context, AttributeSet attrs) {
		this(context, attrs,0);
	}

	public CommonScaleRectangleFocusView(Context context, AttributeSet attrs, int defStyle) {
	...
	protected void initViews(Context context,AttributeSet attrs,int defStyle) {
		...
		mDrawable = getResources().getDrawable(R.drawable.focus_rectangle);
		FocusBorder = getResources().getDimensionPixelSize(R.dimen.focus_rectangle_border);
