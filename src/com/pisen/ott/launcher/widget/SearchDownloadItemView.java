 ...
 */
public class SearchDownloadItemView extends FrameLayout implements OnClickListener, IDownloadItem {
	...
	public SearchDownloadItemView(Context context) {
		this(context, null);
	}

	public SearchDownloadItemView(Context context, AttributeSet attrs) {
		super(context, attrs);
