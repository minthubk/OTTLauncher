...
public class FocusListView extends ListView {
	...
	private static final int FocusWidth = 25;
	private static final int FocusHeight = 27;
	...
	protected void dispatchDraw(Canvas canvas) {
		if (hasFocus()) {
			...
			//绘制浮层
			canvas.save();
			mDrawable.setBounds(currentRect.left-FocusWidth, currentRect.top-FocusHeight, currentRect.right + FocusWidth, currentRect.bottom + FocusHeight);
